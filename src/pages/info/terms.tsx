    ...
    <List>
      <Jang index={1} title="총칙">
        ...
        <Jo index={2} title="정의">
          ...
          <HoList>
            ...
            <>
              “이용자”라 함은 “회사”의 사이트에 접속하여 이 약관에 따라 “회사”가
              제공하는 “콘텐츠” 및 제반서비스를 이용하는 회원 및 비회원을
              말합니다.
            </>
            <>
              “회원”이라 함은 “회사”와 이용계약을 체결하고 “이용자” 아이디(ID)를
              부여받은 “이용자”로서 “회사”의 정보를 지속적으로 제공받으며
              “회사”가 제공하는 서비스를 지속적으로 이용할 수 있는 자를
              말합니다.
            </>
            <>
            ...
            <>
              “콘텐츠”라 함은 정보통신망이용촉진 및 정보보호 등에 관한 법률
            ...
            <>
              “아이디(ID)”라 함은 “회원”의 식별과 서비스이용을 위하여 “회원”이
        ...
        <Jo index={4} title="약관의 게시 등">
          <HangList>
            <>
              ...
              해당 약관의 내용을 확인할 수 있도록 기술적 조치를 취합니다.
            </>
            <>
            ...
            <>
              “회사”는 “이용자”가 약관에 동의하기에 앞서 약관에 정하여져 있는
              내용 중 청약철회, 환불조건 등과 같은 중요한 내용을 이용자가 쉽게
        ...
        <Jo index={5} title="약관의 개정 등">
          <HangList>
            <>
              ...
              소비자보호에 관한 법률, 약관의 규제에 관한 법률 등 관련법을
              위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.
            </>
            <>
              “회사”가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여
              현행약관과 함께 서비스초기화면에 그 적용일자 7일 이전부터 적용일
              후 상당한 기간동안 공지하고, 기존회원에게는 개정약관을
              전자우편주소로 발송합니다.
            </>
            <>
              “회사”가 약관을 개정할 경우에는 개정약관 공지 후 개정약관의 적용에
              대한 “이용자”의 동의 여부를 확인합니다. “이용자”가 개정약관의
              적용에 동의하지 않는 경우 “회사” 또는 “이용자”는 콘텐츠 이용계약을
              해지할 수 있습니다. 이때, “회사”는 계약해지로 인하여 “이용자”가
              입은 손해를 배상합니다.
            </>
          </HangList>
        </Jo>
      ...
      <Jang index={2} title="회원가입">
        <Jo index={7} title="회원가입">
          <HangList>
            ...
            <>
              “회사”는 상기 “이용자”의 신청에 대하여 회원가입을 승낙함을
        ...
        <Jo index={8} title="미성년자의 회원가입에 관한 특칙">
          <HangList>
            ...
            <>
              ...
              철회할 수 있으며, 이러한 경우에 “회사”는 지체 없이 필요한 조치를
              취해야 합니다.
            </>
          </HangList>
        </Jo>
        ...
        >
          <HangList>
            ...
            <>
              제2항의 경우에 해당 “회원”이 “회사”에 그 사실을 통지하지 않거나,
        ...
        <Jo index={12} title="회원탈퇴 및 자격 상실 등">
          <HangList>
            ...
            <>
              “회원”이 다음 각호의 사유에 해당하는 경우, “회사”는 회원자격을
              제한 및 정지시킬 수 있습니다.
              <HoList>
                <>가입신청 시에 허위내용을 등록한 경우</>
                <>
                  “회사”의 서비스이용대금, 기타 “회사”의 서비스이용에 관련하여
            ...
            <>
              ...
              경우 “회원”에게 이를 통지하고, 회원등록 말소 전에 최소한 30일
      ...
      <Jang index={3} title="콘텐츠이용계약">
          ...
          <HangList>
            <>
              ...
              <HoList>
                ...
                <>“콘텐츠”의 제작 및 표시 연월일</>
                <>
                  “콘텐츠” 제작자의 성명(법인인 경우에는 법인의 명칭), 주소,
                  전화번호
                </>
            ...
            <>
              “회사”는 “콘텐츠”별 이용가능기기 및 이용에 필요한 최소한의
              기술사양에 관한 정보를 계약체결과정에서 “이용자”에게 제공합니다.
            </>
          </HangList>
        </Jo>
        <Jo index={14} title="이용계약의 성립 등">
          <HangList>
            <>
              ...
              청약철회가 불가능한 “콘텐츠”에 대해 “회사”가 취한 조치에 관련한
              내용에 대한 확인 4. 이 약관에 동의하고 위 제3호의 사항을
              확인하거나 거부하는 표시(예, 마우스 클릭) 5. “콘텐츠”의 이용신청에
              관한 확인 또는 “회사”의 확인에 대한 동의 6. 결제방법의 선택
            </>
            <>
              “회사”는 “이용자”의 이용신청이 다음 각 호에 해당하는 경우에는
              승낙하지 않거나 승낙을 유보할 수 있습니다. 1. 실명이 아니거나
              타인의 명의를 이용한 경우 2. 허위의 정보를 기재하거나, “회사”가
              제시하는 내용을 기재하지 않은 경우 3. 미성년자가 청소년보호법에
              의해서 이용이 금지되는 “콘텐츠”를 이용하고자 하는 경우 4. 서비스
              관련 설비의 여유가 없거나, 기술상 또는 업무상 문제가 있는 경우
            </>
            <>
              “회사”의 승낙이 제16조 제1항의 수신확인통지형태로 “이용자”에게
              도달한 시점에 계약이 성립한 것으로 봅니다.
            </>
            <>
              “회사”의 승낙의 의사표시에는 “이용자”의 이용신청에 대한 확인 및
              서비스제공 가능여부, 이용신청의 정정․취소 등에 관한 정보 등을
              포함합니다.
            </>
          </HangList>
        </Jo>
        ...
        <Jo index={17} title="“회사”의 의무">
          ...
          <>
            “회사”는 “이용자”가 안전하게 “콘텐츠”를 이용할 수 있도록
            개인정보(신용정보 포함)보호를 위해 보안시스템을 갖추어야 하며
            개인정보보호정책을 공시하고 준수합니다.
          </>
          <>
            “회사”는 “이용자”가 콘텐츠이용 및 그 대금내역을 수시로 확인할 수
            있도록 조치합니다.
          </>
          <>
            “회사”는 콘텐츠이용과 관련하여 “이용자”로부터 제기된 의견이나 불만이
            정당하다고 인정할 경우에는 이를 지체없이 처리합니다. 이용자가 제기한
            의견이나 불만사항에 대해서는 게시판을 활용하거나 전자우편 등을
            통하여 그 처리과정 및 결과를 전달합니다.
          </>
          <>
            “회사”는 이 약관에서 정한 의무 위반으로 인하여 “이용자”가 입은
            손해를 배상합니다.
          </>
        </Jo>
        ...
        <Jo index={20} title="콘텐츠서비스의 제공 및 중단">
          <HangList>
            ...
            <>
              ...
              또는 운영상 상당한 이유가 있는 경우 콘텐츠서비스의 제공을
              일시적으로 중단할 수 있습니다. 이 경우 “회사”는 제11조[“회원”에
              대한 통지]에 정한 방법으로 “이용자”에게 통지합니다. 다만, “회사”가
              사전에 통지할 수 없는 부득이한 사유가 있는 경우 사후에 통지할 수
              있습니다.
            </>
            <>
              “회사”는 상당한 이유 없이 콘텐츠서비스의 제공이 일시적으로
              중단됨으로 인하여 “이용자”가 입은 손해에 대하여 배상합니다. 다만,
              “회사”가 고의 또는 과실이 없음을 입증하는 경우에는 그러하지
              아니합니다.
            </>
            <>
              “회사”는 콘텐츠서비스의 제공에 필요한 경우 정기점검을 실시할 수
              있으며, 정기점검시간은 서비스제공화면에 공지한 바에 따릅니다.
            </>
            <>
              사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로
              콘텐츠서비스를 제공할 수 없게 되는 경우에는 “회사”는
              제11조[“회원”에 대한 통지]에 정한 방법으로 “이용자”에게 통지하고
              당초 “회사”에서 제시한 조건에 따라 “이용자”에게 보상합니다. 다만,
              “회사”가 보상기준 등을 고지하지 아니하거나, 고지한 보상기준이
              적절하지 않은 경우에는 “이용자”들의 마일리지 또는 적립금 등을 현물
              또는 현금으로 “이용자”에게 지급합니다.
            </>
          </HangList>
        </Jo>
        <Jo index={21} title="콘텐츠서비스의 변경">
          <HangList>
            ...
            <>
              ...
              변경사유, 변경될 콘텐츠서비스의 내용 및 제공일자 등을 그 변경 전
              7일 이상 해당 콘텐츠초기화면에 게시합니다.
            </>
            <>
              제2항의 경우에 변경된 내용이 중대하거나 “이용자”에게 불리한
              경우에는 “회사”가 해당 콘텐츠서비스를 제공받는 “이용자”에게
              제11조[“회원”에 대한 통지]에 정한 방법으로 통지하고 동의를
              받습니다. 이때, “회사”는 동의를 거절한 “이용자”에 대하여는 변경전
              서비스를 제공합니다. 다만, 그러한 서비스 제공이 불가능할 경우
              계약을 해지할 수 있습니다.
            </>
            <>
              “회사”는 제1항에 의한 서비스의 변경 및 제3항에 의한 계약의 해지로
